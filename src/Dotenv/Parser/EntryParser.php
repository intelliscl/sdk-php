...
use Dotenv\Util\Str;
use ResultType\Error;
use ResultType\Result;
use ResultType\Success;
...
final class EntryParser
{
     ...
     * @param string $entry
     *
     * @return \ResultType\Result<\Dotenv\Parser\Entry,string>
     */
     ...
     * @param string $line
     *
     * @return \ResultType\Result<array{string,string|null},string>
     */
    private static function splitStringIntoParts(string $line)
    {
        ...
        /** @var \ResultType\Result<array{string,string|null},string> */
     ...
     * @param string $name
     *
     * @return \ResultType\Result<string,string>
     */
     ...
     * @param string $value
     *
     * @return \ResultType\Result<\Dotenv\Parser\Value,string>
     */
     ...
     * @param string $token
     *
     * @return \ResultType\Result<array{string,bool,int},string>
     */
    private static function processToken(int $state, string $token)
    {
        switch ($state) {
            case self::INITIAL_STATE:
                if ($token === '\'') {
                    /** @var \ResultType\Result<array{string,bool,int},string> */
